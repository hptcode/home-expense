...
export default function Reports() {
  ...
  function exportCsv() {
    ...
    for (const c of data.byCategory) rows.push(`${c.category},${signed(c.amount, c.direction)}`);
    rows.push('');
    ...
    for (const c of data.yearlyByCategory) rows.push(`${c.category},${signed(c.amount, c.direction)}`);
    rows.push('');
